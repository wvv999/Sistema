...
// Log inicial
error_log('Iniciando update_auth_status.php');
...
try {
    ...
    $currentQuery = "SELECT auth_status FROM service_orders WHERE id = :id";
    ...
    error_log('Erro em update_auth_status.php: ' . $e->getMessage());
